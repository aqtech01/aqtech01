...
<h2>I'm Abdul Qadeer! 👋</h2>

```js
const profile = {
  name: "Abdul Qadeer",
  bio: "I am a Junior back end / django, and I have 1+ years of experience.",
  skills: {
     frontend: ["HTML", "CSS","BootStrap","Tailwind"],
     backend: ["django", "SQLite",  "MySql", "REST API"],
     framework: ["Bootstrap", "TailwindCSS", "Django"],
     <!---architectures: [
